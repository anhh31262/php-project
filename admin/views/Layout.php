...
<head>
    ...
    <meta content="webthemez" name="producer" />
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><strong>FURNI</strong></a>
				<div id="sideNav" href="">
        ...
        <div id="page-wrapper" >
		  <div class="header"> 
                ...
                <?php if(isset($_SESSION['email'])): ?>
                    <li>Hello <a href="#" style = "font-weight: 600; color: #ae7b4e;"><?php echo $_SESSION['email']; ?></a>
               ...
               <footer><p style="position: absolute; left: 3%;color: white;"></p></footer>
    </div>
            </div>
