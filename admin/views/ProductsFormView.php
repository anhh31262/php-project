...
<div class="col-md-12">  
    <div class="panel panel-primary" style="border-color: #ae7b4e !important; border-radius: 5px;">
        <div class="panel-heading" style="background-color: #ae7b4e; border-color: #ae7b4e;">Add edit product</div>
        ...
        <form method="post" enctype="multipart/form-data" action="<?php echo $action; ?>">
            ...
            <div class="row" style="margin-top:5px;">
                ...
                <div class="col-md-10">
                    <input type="text" value="<?php echo isset($record->producer)?$record->producer:""; ?>" name="producer" class="form-control" required>
                </div>
            </div>
            <div class="row" style="margin-top:5px;">
