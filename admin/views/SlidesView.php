...
<div class="col-md-12">
    <div style="margin-bottom:5px;">
        <a href="index.php?controller=slides&action=create" class="btn" style="background: #ae7b4e; color: white;"><i style="margin-right: 6px;" class="fas fa-plus"></i>Add new</a>
    </div>
    <div class="panel panel-primary" style="border-color: #ae7b4e !important; border-radius: 5px;">
        <div class="panel-heading" style="background-color: #ae7b4e; border-color: #ae7b4e;">List slides</div>
        <div class="panel-body">
            ...
            <ul class="pagination">
                ...
                <li class="page-item"><a style="color: #ae7b4e;" href="index.php?controller=slides&p=<?php echo $i; ?>" class="page-link"><?php echo $i; ?></a></li>
                <?php endfor; ?>
            </ul>
        </div>
    </div>
