...
<div class="col-md-12">
    <div class="panel panel-primary" style="border-color: #ae7b4e !important; border-radius: 5px;">
        <div class="panel-heading" style="background-color: #ae7b4e; border-color: #ae7b4e;">List orders</div>
        <div class="panel-body">
            ...
            <ul class="pagination">
                ...
                <li class="page-item"><a style="color: #ae7b4e;" href="index.php?controller=orders&p=<?php echo $i; ?>" class="page-link"><?php echo $i; ?></a></li>
                <?php endfor; ?>
            </ul>
        </div>
    </div>
