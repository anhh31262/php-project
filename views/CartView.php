                ...
                <div class="template-cart">
                                    ...
                                    <?php foreach ($_SESSION["cart"] as $product) : ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle !important; text-align: center !important;"><a onclick="return window.confirm('Are you sure?');" href="index.php?controller=cart&action=delete&id=<?php echo $product["id"]; ?>" data-id="2479395"><i style="color: #ae7b4e;" class="fa fa-trash"></i></a></td>
                                            </tr>
                                        </tbody>
                                    <?php endforeach; ?>
                                    <?php if ($this->cartNumber() > 0) : ?>
                    ...
                    <?php if ($this->cartNumber() > 0) : ?>
                        <div class="total-cart" style="margin-bottom: 20px; text-align: end;">
                            ...
                            <a href="index.php?controller=cart&action=checkout" class="button black thanhtoan" onclick="return window.confirm('Đặt hàng thành công!');">THANH TOÁN</a>
                        </div>
