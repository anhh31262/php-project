                    ...
                    <div class="carousel-inner">
                        ...
                        <?php foreach ($slide as $rows) : ?>
                            <div class="carousel-item active">
                                <a href="#"><img src="assets/upload/slides/<?php echo $rows->photo; ?>" class="img-fluid" style="height: 386px;" width="900px" alt="First slide"></a>
                            </div>
                            <?php
                            $conn = Connection::getInstance();
                            ...
                            <?php foreach ($slides as $rows) : ?>
                                <div class="carousel-item">
                                    <a href="#"><img src="assets/upload/slides/<?php echo $rows->photo; ?>" class="img-fluid" style="height: 386px;" width="900px" alt="Second slide"></a>
                                </div>
                            <?php endforeach; ?>
                        <?php endforeach; ?>
                    </div>
