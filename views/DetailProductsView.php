                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="uudai my-3">
                                <h6 class="header font-weight-bold">Khuyến mãi & Ưu đãi tại FURNI:</h6>
                                <ul>
                                    <li><b>Miễn phí giao hàng </b>cho đơn hàng từ 150.000đ ở TP.HCM và 300.000đ ở
                                        Tỉnh/Thành khác <a href="#">>> Chi tiết</a></li>
                                    <li><b>Sản phẩm HOT - GIẢM 25% </b><a href="#">>>Xem ngay</a></li>
                                    <li>Tặng sản phẩm khuyến mại cho mỗi đơn hàng</li>
                                    <li>Bao hành miễn phí (theo yêu cầu)</li>
                                </ul>
                            </div>
        ...
        <div class="noidung bg-white" style=" width: 100%;">
            ...
            <div class="khoisanpham" style="padding-bottom: 2rem;">
                ...
                <?php foreach ($sameProduct as $rows) : ?>
                    <div class="card">
                        <a href="index.php?controller=products&action=detail&id=<?php echo $rows->id; ?>" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip" data-placement="bottom" title="<?php echo $rows->name; ?>">
                            ...
                            <div class="card-body noidungsp mt-3">
                                ...
                                <small class="nxs text-muted"><?php echo $rows->athour; ?></small>
