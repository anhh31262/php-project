...
<head>
    <title>FURNI-Mua bán trực tuyến giá rẻ nhất</title>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="dichvu d-flex align-items-center">
                        ...
                        <div class="noidung">
                            <h3 class="tieude font-weight-bold">HƠN 14.000 SẢN PHẨM CHẤT LƯỢNG</h3>
        ...
        <div class="container py-4">
            <div class="row">
                <div class="col-md-3 col-xs-6">
                    <div class="gioithieu">
                        <h3 class="header text-uppercase font-weight-bold">Về FURNI</h3>
